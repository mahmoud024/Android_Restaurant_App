...
import com.example.final_project.Fragments.ContactFragment;
import com.example.final_project.Fragments.DealsFragment;
import com.example.final_project.Fragments.FavoritesFragment;
import com.example.final_project.Fragments.HomeFragment;
import com.example.final_project.Fragments.Adapters.OrdersFragment;
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_categories:
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new CatagoriesFragment()).commit();
                break;
